  ...
  <div class="max-w-5xl mx-auto">
    ...
    <div class="text-center mb-12">
      ...
      <p class="text-xl text-slate-500 dark:text-slate-400 max-w-2xl mx-auto">
        Create food packages with barcodes, making it easy for shelters and food banks to identify and process your donation.
      </p>
    </div>
    <!-- Feature Cards -->
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
      ...
      <a href="{{site.baseurl}}/donate/create"
        class="group relative bg-white dark:bg-slate-800 rounded-lg shadow-md hover:shadow-lg border border-slate-200 dark:border-slate-700 p-8 transition-all duration-300 overflow-hidden">
        <div class="relative">
          <div class="w-14 h-14 rounded-lg bg-primary-500 flex items-center justify-center shadow-md mb-5 transition-transform">
      ...
      <a href="{{site.baseurl}}/donate/scan"
        class="group relative bg-white dark:bg-slate-800 rounded-lg shadow-md hover:shadow-lg border border-slate-200 dark:border-slate-700 p-8 transition-all duration-300 overflow-hidden">
        <div class="relative">
          <div class="w-14 h-14 rounded-lg bg-secondary-500 flex items-center justify-center shadow-md mb-5 transition-transform">
            <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <a href="{{site.baseurl}}/donate/history"
        class="group relative bg-white dark:bg-slate-800 rounded-lg shadow-md hover:shadow-lg border border-slate-200 dark:border-slate-700 p-8 transition-all duration-300 overflow-hidden">
        <div class="relative">
          <div class="w-14 h-14 rounded-lg bg-accent-600 flex items-center justify-center shadow-md mb-5 transition-transform">
            <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <!-- How It Works -->
    <div class="bg-white dark:bg-slate-800 rounded-lg shadow-md border border-slate-200 dark:border-slate-700 p-8 sm:p-10 mb-12">
      <div class="text-center mb-8">
        <span class="inline-block px-4 py-2 bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-300 rounded-full text-sm font-semibold mb-3">How It Works</span>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
      <div class="bg-white dark:bg-slate-800 rounded-lg shadow-md border border-slate-200 dark:border-slate-700 p-5 text-center">
    ...
    <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
      <div class="bg-white dark:bg-slate-800 rounded-lg shadow-md border border-slate-200 dark:border-slate-700 p-5 text-center">
        <p id="stat-claimed" class="text-3xl font-bold text-accent-600 dark:text-accent-400 mb-1">0</p>
